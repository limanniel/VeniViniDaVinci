...
void Texture2D::Render(Rect2D sourceRect, SDL_RendererFlip flip, double angle)
{
	SDL_RenderCopyEx(mRenderer, mTexture, nullptr, &(SDL_Rect)sourceRect, 0, nullptr, flip);
}
