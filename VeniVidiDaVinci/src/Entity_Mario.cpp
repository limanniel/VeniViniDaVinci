...
{
	SDL_Rect portionOfSpriteSheet{ _activeFrame, _jumpFrame, 32, 42 };
	SDL_Rect sourceRect{ static_cast<int>(_Position.x), static_cast<int>(_Position.y), 32, 42 };
